        ...
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-white border-b border-gray-100">
                ...
                <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div v-if="$page.props.user.permissions.includes('read_categories') "
                            ...
                            <div v-if="$page.props.user.permissions.includes('read_lessons')"
                                class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                            ...
                            <div v-if="$page.props.user.permissions.includes('read_roles')"
                                class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}"
                    ...
                    <div v-if="$page.props.user.permissions.includes('read_categories')" class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink :href="route('categories.index')" :active="route().current('categories.*') ">
                            Categories
                        </ResponsiveNavLink>
                    </div>

                    <div v-if="$page.props.user.permissions.includes('read_lessons')" class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink :href="route('lessons.index')" :active="route().current('lessons.*') ">
                            Lessons
                        </ResponsiveNavLink>
                    </div>

                    <div v-if="$page.props.user.permissions.includes('read_roles')" class="pt-2 pb-3 space-y-1">
